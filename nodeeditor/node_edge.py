...
class Edge(Serializable):
    ...
    def start_socket(self, value):
        # if assigned to some socket before, delete from the socket
    ...
    def updatePositions(self):
        ...
        # debug available sockets Start Socket (SS), End Socket (ES)
    ...
    def remove(self):
        ...
        if DEBUG: print("> - remove edge from all socket")
        self.remove_from_sockets()
        if DEBUG: print("> - remove grRdge")
        self.scene.grScene.removeItem(self.grEdge)
        self.grEdge = None
